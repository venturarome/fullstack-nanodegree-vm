...
from database_setup import Base, Recipe, Aliment, Ingredient
...
# Fill aliments (modify to use a map and a loop)
aliment01 = Aliment(name = "Eggs", nutriment = "proteins")
aliment02 = Aliment(name = "Salt", nutriment = "salts")
aliment03 = Aliment(name = "Potato", nutriment = "carbohydrates")
aliment04 = Aliment(name = "Onion", nutriment = "vitamins")
aliment05 = Aliment(name = "Olive oil", nutriment = "fat")
aliment06 = Aliment(name = "Chickpeas", nutriment = "carbohydrates")
aliment07 = Aliment(name = "Cumin", nutriment = "carbohydrates")
aliment08 = Aliment(name = "Sweet pepper", nutriment = "carbohydrates")
aliment09 = Aliment(name = "Lemon", nutriment = "carbohydrates")
...
session.add(ingredient02)
session.add(ingredient03)
session.add(ingredient04)
session.commit()

recipe02 = Recipe(name = "Houmus")
...
ingredient10 = Ingredient(
	...
	amount = 3,
	units = "teaspoons")
session.add(recipe02)
session.add(ingredient05)
session.add(ingredient06)
session.add(ingredient07)
session.add(ingredient08)
session.add(ingredient09)
